      ...
      child: Card(
        child: Padding(
          ...
          child: Row(children: <Widget>[
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    FutureBuilder<DocumentSnapshot>(
                      future: FirebaseFirestore.instance.collection("usuarios").doc(interesse.idUsuarioInteressado).get(),
            ...
            //BOTÃO LIGAR
            if( this.onPressedLigacao != null ) Expanded(
              flex: 1,
            ...
            // //BOTÃO WHATSAPP
            // if( this.onPressedWhats != null ) Expanded(
            //   flex: 1,
            //   child: MaterialButton(
            //     //color: Colors.red,
            //     padding: EdgeInsets.all(15),
            //     onPressed: this.onPressedWhats,
